...
to setup-node
  ...
  [
    ...
    [
      let a 360 / (int (graph-size / 2)) * who
      let r max-pxcor - 1
      setxy (r * sin a) (r * cos a)
    ]
    [
      let a 360 / (graph-size - int (graph-size / 2)) * who
      let r max-pxcor - 7
      setxy (r * sin a) (r * cos a)
    ]
  ]
  ...
  [
    ifelse who < (graph-size / 2)
    [
      let a 360 / (int (graph-size / 2)) * who + int (0.5 * 360 / (int (graph-size / 2)))
      let r max-pxcor - 1
      setxy (r * sin a) (r * cos a)
    ]
    [
  ...
  if layout = "4"
  [
    ifelse who < (graph-size / 3)
    [
      let a 360 / (int (graph-size / 3)) * who
      let r max-pxcor - 1
      setxy (r * sin a) (r * cos a)
    ]
    [
      ifelse who < (2 * graph-size / 3)
      [
        let a 360 / (int (2 * graph-size / 3) - int (graph-size / 3)) * who
        let r max-pxcor - 4
        setxy (r * sin a) (r * cos a)
      ]
      [
        let a 360 / (int (graph-size - 2 * graph-size / 3)) * who
        let r max-pxcor - 7
        setxy (r * sin a) (r * cos a)
      ]
    ]
  ...
  [
    ifelse who < graph-size / 2
    [
      setxy (who mod 3) * 10 - 15 (int (who / 3)) * 4 - 15
    ]
    [
      setxy (who mod 3) * 10 - 15 + 5 (int ((who - int (graph-size / 2)) / 3)) * 4 - 15 + 2
    ]
  ]
end
